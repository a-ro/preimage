...
from preimage.metrics.structured_output import zero_one_loss, hamming_loss
...
class TestStructuredOutputMetrics(unittest2.TestCase):
    ...
    def test_same_words_hamming_loss_is_zero(self):
        loss = hamming_loss(self.unicorn_potato, self.unicorn_potato)
        self.assertEqual(loss, 0.)
