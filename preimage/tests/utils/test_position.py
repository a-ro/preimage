...
class TestPosition(unittest2.TestCase):
    def setUp(self):
        ...
        self.Position_weights_one_sigma_p_three_positions = [[1., 0.6065307, 0.1353353], [0.6065307, 1., 0.6065307],
    ...
    def test_one_sigma_p_three_positions_compute_position_weights_matrix_returns_expected_weights(self):
        ...
        numpy.testing.assert_array_almost_equal(position_weights, self.Position_weights_one_sigma_p_three_positions)
